...
// you judge that the i-th of them has deliciousness Ai. Of course, you want to eat pastries whose total deliciousness is as high as possible. Unfortunately, you can't 
// just buy everything out. There are K customers in the store, including you. They form a queue to order pastries, of which you're the L-th person. Each customer, 
// including you, will do the following:
